...
class graficoBarras(QWidget):
        ...
        if connection is not None:
            try:
                ...
                select_query = (
                    ...
                    "WHERE UsuarioDispo = (SELECT CodigoUsuario FROM Usuario WHERE NombreUsuario = %s) "
                    "GROUP BY DATE(fecha);"
                )
    ...
    def crearGraficoBarras(self):
        Kwh = self.actualizar_variable("Usuario3")  # Reemplaza "Usuario1" con el nombre del usuario deseado
